...
VALUES (1, 'krodriguez', 'krodriguez@icesi.edu.co', 'Kevin Rodriguez', 'TEACHER'),
...
INSERT INTO classrooms (id, name, course_code, semester,teacher_id)
VALUES (1, 'Computacion en Internet II - Grupo 1', 'CI-2026-G1', '2026-02', 1),
...
INSERT INTO assignments (id, title, description, deadline, max_score, classroom_id)
VALUES (1, 'Taller 1: Spring Data JPA', 'Implementacion de modelos relacionales y Query Methods', '2026-03-20 23:59:59',
        100, 1),
       (2, 'Parcial 1: Persistencia Avanzada', 'Examen practico de JPA con relaciones complejas', '2026-04-10 18:00:00',
        100, 1),
...
INSERT INTO repositories (id, name, is_template, is_private, created_at, assignment_id, owner_id, parent_repo_id)
VALUES (1, 'template-jpa-exam', true, false, '2026-03-01 08:00:00', 1, 1, NULL),
...
INSERT INTO pull_requests (id, title, status, pr_number, created_at, repository_id, author_id, reviewer_id)
VALUES (1, 'Entrega Taller JPA - Camila Jimenez', 'OPEN', 1, '2026-03-18 19:30:00', 4, 6, 4),
...
INSERT INTO commits (id, commit_hash, message, lines_added, lines_deleted, commit_date, repository_id, author_id)
VALUES (1, 'a1b2c3d', 'Initial commit with starter code', 150, 0, '2026-03-01 08:10:00', 1, 1),
